// Upgrade NOTE: replaced 'defined ALPHATEST' with 'defined (ALPHATEST)'

Shader "MeshShaderTransluscent"
{
	...
	Properties
	{
		...
		SubShader
		{
			...
			//Tags { "Queue" = "Transparent" "IgnoreProjector" = "False"  "RenderType" = "TranceparnetCutout" "ShaderUsage" = "Creator" }
			...
			Pass
			{
				...
				half4 frag(v2f i) : SV_Target
				{
					...
					color.xyz += specularColor;// (specular* _SpecularColor.rgb);
