...
CBUFFER_END
    ...
    UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
        ...
        UNITY_DOTS_INSTANCED_PROP(half4, _ClippingArea)
    ...
    #define _ClippingArea           UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(half4 , Metadata__ClippingArea)
