...
using static UnityEditor.Rendering.Universal.ShaderGUI.Vulcanus_LitGUI;
...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    internal class Vulcanus_LitShader : BaseShaderGUI
    {
        private Vulcanus_LitGUI.LitProperties litProperties;
        private Vulcanus_GUI.Properties vulcanusProperties;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litProperties = new Vulcanus_LitGUI.LitProperties(properties);
            vulcanusProperties = new Vulcanus_GUI.Properties(properties);
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            if (litProperties.workflowMode != null)
                DoPopup(Vulcanus_LitGUI.Styles.workflowModeText, litProperties.workflowMode, Enum.GetNames(typeof(Vulcanus_LitGUI.WorkflowMode)));
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            {
                EditorGUI.BeginChangeCheck();
                materialEditor.ShaderProperty(litProperties.highlights, Vulcanus_LitGUI.Styles.highlightsText);
                materialEditor.ShaderProperty(litProperties.reflections, Vulcanus_LitGUI.Styles.reflectionsText);
                if (EditorGUI.EndChangeCheck())
                {
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
        {
            ...
            {
                material.SetFloat("_WorkflowMode", (float)Vulcanus_LitGUI.WorkflowMode.Specular);
            ...
            {
                material.SetFloat("_WorkflowMode", (float)Vulcanus_LitGUI.WorkflowMode.Metallic);
