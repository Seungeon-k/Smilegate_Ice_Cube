...
half3 GlobalIllumination(BRDFData brdfData, half3 bakedGI, half fersnelRatio, half occlusion, half3 normalWS, half3 viewDirectionWS)
{
    ...
    fresnelTerm = lerp(0, fresnelTerm, upwardCoef) * fersnelRatio;
...
// #endif
    ...
    half fersnelRatio = 1;
    half3 color = GlobalIllumination(brdfData, inputData.bakedGI, fersnelRatio, surfaceData.occlusion,
