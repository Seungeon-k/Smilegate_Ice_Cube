...
//====================================================================================================
    ...
    inline void PSDitherClip(half4 positionCS, half ditherAlpha)
	{		
	    Unity_Dither_positionCS(ditherAlpha, positionCS.xy, ditherAlpha);
	    clip(ditherAlpha - 0.000001);
	}
    ...
    inline void PSDissolveClip(TEXTURE2D_PARAM(tex, smp), half2 uv, half dissolveRatio)
	{
	    float noise = SAMPLE_TEXTURE2D(tex, smp, uv).g;
	    clip(noise - lerp(-0.000001, 1.000001, dissolveRatio));
	}
