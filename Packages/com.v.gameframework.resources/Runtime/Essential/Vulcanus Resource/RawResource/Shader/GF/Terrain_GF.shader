    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                return SAMPLE_TEXTURE2D_GRAD(_BaseMap, sampler_BaseMap, uv, ddx(uv), ddy(uv));
                ...
                float3 rBase = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, rUV);

                half3 gBase = splatRatio.g * SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, gUV);
                half3 bBase = splatRatio.b * SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, bUV);
                half3 eBase = splatRatio.a * SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, aUV);
                ...
                half3 rNormalTS = splatRatio.r * CustomSampleNormal(rUV, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap));
                half3 gNormalTS = splatRatio.g * CustomSampleNormal(gUV, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap));
                half3 bNormalTS = splatRatio.b * CustomSampleNormal(bUV, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap));
                half3 aNormalTS = splatRatio.a * CustomSampleNormal(aUV, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap));
...
#ifdef _SPECULARMAP
                half4 rSpecularSmoothness = splatRatio.r * SAMPLE_TEXTURE2D(_SpecGlossMap, sampler_SpecGlossMap, rUV) * _SpecColor;
                half4 gSpecularSmoothness = splatRatio.g * SAMPLE_TEXTURE2D(_SpecGlossMap, sampler_SpecGlossMap, gUV) * _SpecColor;
                half4 bSpecularSmoothness = splatRatio.b * SAMPLE_TEXTURE2D(_SpecGlossMap, sampler_SpecGlossMap, bUV) * _SpecColor;
                half4 aSpecularSmoothness = splatRatio.a * SAMPLE_TEXTURE2D(_SpecGlossMap, sampler_SpecGlossMap, aUV) * _SpecColor;
