Shader "ZAMMYSMITH/SpecialFX/RushingPierrot_Icator"
{
    Properties
    {
        ...
        [Space(10)]
        _MorphRatio ("Appear Ratio", Range(0, 1)) = 0.0
        _MorphMax   ("Appear Max", Range(0, 1)) = 1.0
        _MorphWidth ("Morph Width", Range(0.0001, 1)) = 0.1
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_TARGET
            {
                ...
                // NEW: 0~1 기반 Morph
                half morph = saturate(_MorphRatio) * saturate(_MorphMax); // 0~_MorphMax
                half alpha = smoothstep(0.0h, _MorphWidth, morph - i.uv.x);
