...
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class Vulcanus_SimpleLitGUI_GF
    {
        ...
        public static void Advanced(SimpleLitProperties properties)
        {
            ...
            var result= EditorGUILayout.Toggle(Styles.highlightsText, (properties.specHighlights.floatValue == 1)) ? 1 : 0;
            EditorGUI.showMixedValue = false;
            if (EditorGUI.EndChangeCheck())
            {
                properties.specHighlights.floatValue = result;
            }
        ...
        {
            CoreUtils.SetKeyword(material, "_SPECULAR_COLOR", (material.GetFloat("_SpecularHighlights") == 1));
            ...
            //bool hasMap = material.HasProperty("_SpecGlossMap");
