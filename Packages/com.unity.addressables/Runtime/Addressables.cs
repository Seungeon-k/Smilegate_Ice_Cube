...
namespace UnityEngine.AddressableAssets
{
    ...
    public static class Addressables
    {
        ...
        public static void RemoveResourceLocationByPrimaryKey(IResourceLocator loc)
        {
            var resourceLocationMap = loc as ResourceLocationMap;

            if (resourceLocationMap != null)
            {
                foreach (var location in resourceLocationMap.Locations)
                {
                    m_Addressables.RemoveResourceLocationByPrimaryKey(location.Key);
                }
            }
        }
    }
