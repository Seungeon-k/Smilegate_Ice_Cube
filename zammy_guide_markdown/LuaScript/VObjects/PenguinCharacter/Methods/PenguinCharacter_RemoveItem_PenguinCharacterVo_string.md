---
title: RemoveItem
source_url: https://developers-zammysmith.onstove.com/ko/LuaScript/VObjects/PenguinCharacter/Methods/PenguinCharacter_RemoveItem_PenguinCharacterVo_string
source_path: LuaScript/VObjects/PenguinCharacter/Methods/PenguinCharacter_RemoveItem_PenguinCharacterVo_string.html
...
`RemoveItem`은 캐릭터가 현재 보유하고 있는 아이템 중, 지정한 `itemId`에 해당하는 아이템을 제거하는 함수입니다.
...
character:RemoveItem(paletteItem.itemId)
```
